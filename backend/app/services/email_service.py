...
def send_verification_email(email: str, verification_link: str, code_6_digits: str) -> None:
    ...
    if not _is_smtp_configured():
        ...
        return
    settings = get_settings()
    subject = "Verify your email - Study Guider"
    text = f"""Verify your email address for Study Guider.
...
"""
    html = f"""<p>Verify your email address for Study Guider.</p>
...
def send_password_reset_email(email: str, reset_link: str) -> None:
    ...
    if not _is_smtp_configured():
        ...
        return
    subject = "Reset your password - Study Guider"
    text = f"""You requested a password reset for Study Guider.

Click this link to set a new password: {reset_link}

This link expires in 15 minutes. If you didn't request this, you can ignore this email.
"""
    html = f"""<p>You requested a password reset for Study Guider.</p>
